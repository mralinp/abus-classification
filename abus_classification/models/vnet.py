...
class VNet(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, features=[(16,1),(32,1),(64,2)], bottle_neck_layers=3) -> None:
        ...
        self.output_conv = ConvBatchNormReLuSigmoid(features[0], out_channels)
        ...
        for num_features, num_layers in features:
            ...
            for _ in range(num_layers):
                module.append(ConvBatchNormReLu(in_channels, num_features))
        ...
        for num_features, num_layers in reversed(features):
            self.decoder.append(torch.nn.ConvTranspose3d(num_features*2, num_features))
    ...
    @property
    def bottle_neck_outputs(self):
        return self.__bottle_neck_output
    
    
    @property 
    def encoder_outputs(self):
        return self.__encoder_output
    
    
    @property
    def decoder_output(self):
        return self.__decoder_output
    ...
    def forward(self, x):
        ...
        skip_connections = reversed(self.__encoder_outputs)
